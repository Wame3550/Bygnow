...
const hvac = [
  {
    ...
    description:
      "Get beautifully manicured lawn that enhances your outdoor space.",
    href: "/hvac-installation-pooler-ga",
  },
  {
    name: "HVAC Repair",
    description:
      "Get beautifully manicured lawn that enhances your outdoor space.",
    href: "/hvac-repair-pooler-ga",
  },
  {
...
export default function Header() {
  ...
  return (
    <header className="bg-primary lg:sticky top-0 z-50 border-b border-white border-opacity-10">
      ...
      >
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5 flex items-center gap-2">
            <div className="h-10 w-10 relative">
              <Image fill src="/assets/air.svg" alt="" />
            </div>
            <div className="text-white text-2xl font-bold">HVAC POOLER GA</div>
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          {/* <a
            href="/home-pest-control-missouri-city-texas"
          ...
          <Popover className="relative focus-visible:outline-none">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-11 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">HVAC Pooler GA</span>
              <div className="h-10 w-10 relative">
                <Image fill src="/assets/air.svg" alt="" />
              </div>
            </a>
